...
############################################## GUI SETUP #######################################
def gui_setup():
    file_path = r"C:\mini project\cat2.jpg"
    root = tk.Tk()
...
def recognize_speech():
    ...
    try:
        ...
        label_var.set("Sorry, I didn't understand what you said.")
        return "........."

    except aa.RequestError as e:
        print("Error: ", e)
        label_var.set("Error: " + str(e))
        return "........."
...
def play_Rexie():
    ...
    while True:
        ...
        time.sleep(1)
        numbers={"teja":"+918096737027","chandu":"+919391707543","Harshit":"+916300009256"}
